...
class TestFormatFq:
    ...
    def test_format_fq_pass(self, places, classification_codes, logical_states, expected_result):
        # Act
        fq_args = places._PlacesAPI__format_fq(classification_code=classification_codes,
    ...
    @pytest.mark.usefixtures("places")
    def test_format_fq_errors(self, places, classification_codes, logical_states, expected_result):
        # Act
