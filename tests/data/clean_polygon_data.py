...
def test_clean_polygon():
    ...
    test_data = [
        param({"geometry": simple_polygon1},
              {"geometry": simple_polygon1.copy()},
              id='simple polygon'
              ),
        param({"geometry": simple_polygon2},
              {"geometry": simple_polygon2.copy()},
              id='simple polygon 2'
              ),
        param({"geometry": polygon_with_hole},
              {"geometry": polygon_with_hole.copy()},
              id='polygon with hole'
              ),
        param({"geometry": multipolygon1},
              {"geometry": multipolygon1.copy()},
              id='simple multipolygon'
              ),
        param({"geometry": multipolygon_with_hole},
              {"geometry": multipolygon_with_hole.copy()},
              id='multipolygon with hole'
              ),
        param({"geometry": get_test_polygons("sites_polygon",
                                             "API (uncleaned)")},
              {"geometry": get_test_polygons("sites_polygon",
                                             "QGIS")},
              id='sites polygon'
              ),
        param({"geometry": get_test_polygons("sites_polygon_with_hole",
                                             "API (uncleaned)")},
              {"geometry": get_test_polygons("sites_polygon_with_hole",
                                             "QGIS")},
              id='sites polygon with hole'
              ),
        param({"geometry": get_test_polygons("sites_multipolygon",
                                             "API (uncleaned)")},
              {"geometry": get_test_polygons("sites_multipolygon",
                                             "QGIS")},
              id='sites multipolygon'
              ),
        param({"geometry": get_test_polygons("sites_multipolygon2",
                                             "API (uncleaned)")},
              {"geometry": get_test_polygons("sites_multipolygon2",
                                             "QGIS")},
              id='sites multipolygon2'
              ),
        param({"geometry": get_test_polygons("sites_multipolygon_with_hole",
                                             "API (uncleaned)")},
              {"geometry": get_test_polygons("sites_multipolygon_with_hole",
                                             "QGIS")},
