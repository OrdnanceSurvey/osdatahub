...
if __name__ == "__main__":
    ...
    test_polygons = [
        ("osgb4000000073320773", (391436, 172360, 393874, 174833),
        "sites_multipolygon"),
        ("osgb4000000073320772", (391436, 172360, 393874, 174833),
        "sites_polygon_with_hole"),
        ("osgb4000000073320770", (391436, 172360, 393874, 174833),
        "sites_polygon"),
        ("osgb4000000073320769", (391436, 172360, 393874, 174833),
        "sites_multipolygon_with_hole"),
        ("osgb4000000073495159", (336610, 503920, 338001, 505331),
        "sites_multipolygon2")
        ]
    ...
    for TOID, bbox, save_name in test_polygons:
        ...
        features = FeaturesAPI_NoPostProcessing(key, "sites_functional_site",
                                                extent)
        features.add_filters(
            is_equal("TOID", TOID))
        ...
        with open(rf"{folder}\{save_name}.geojson", 'w', encoding='utf-8') as f:
            geojson.dump(FeatureCollection(results, crs="EPSG:27700"), f,
