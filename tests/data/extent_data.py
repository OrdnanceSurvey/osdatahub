...
def test_from_bbox():
    ...
    test_data = [
        param((600000, 310200, 600900, 310800),
              "epsg:27700",
              Extent(box(600000, 310200, 600900, 310800),
                     "epsg:27700"),
              id='tuple bbox'
              ),
        param(BBox(600000, 310200, 600900, 310800),
              "epsg:27700",
              Extent(box(600000, 310200, 600900, 310800),
                     "epsg:27700"),
              id='bbox object'
...
def test_xml_coords():
    ...
    test_data = [
        ...
        param(Polygon([(0, 0), (5, 7), (10, 0)]),
              "epsg:27700",
              "0.0,0.0 5.0,7.0 10.0,0.0 0.0,0.0",
              id='triangle'
              ),
        param(Polygon([(-3.29, 50.74), (-3.27, 50.74), (-3.27, 50.76)]),
              "epsg:4326",
...
def test_from_ons_code():
    ...
    test_data = [
        param("E0100001",
              json.dumps({"type":"FeatureCollection","features":[{"type":"Feature","geometry":{"type":"Polygon","coordinates":[[[0, 0], [1, 1], [2, 0]]]}}]}),
...
def test_from_ons_code_error():
    ...
    test_data = [
        param("E0100001",
              json.dumps({"type":"FeatureCollection","features":[{"type":"Feature","geometry":{"type":"LineString","coordinates":[[[0, 0], [1, 1], [2, 0]]]}}]}),
              id='line'
        )
    ]
    return test_variables, test_data
...
def test_to_json():
    ...
    test_data = [
        param(Polygon([(0, 0), (5, 5), (10, 0)]),
              "epsg:27700",
              {"type": "Polygon",
               "coordinates": [[(0, 0), (5, 5), (10, 0), (0, 0)]]},
              id='triangle - BNG'
              ),
        param(Polygon([(-3.29, 50.74), (-3.27, 50.74), (-3.27, 50.76)]),
              "epsg:4326",
              {"type": "Polygon",
              "coordinates": [[(50.74, -3.29), (50.74, -3.27),
                               (50.76, -3.27), (50.74, -3.29)]]},
              id='triangle - lonlat'
              )
        ]
    return test_variables, test_data